...
namespace AnarchyChess.Api.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    username_last_changed = table.Column<DateTime>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    final_time_remaining = table.Column<double>(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "blocked_users");

            migrationBuilder.DropTable(name: "current_ratings");

            migrationBuilder.DropTable(name: "messages_logs");

            migrationBuilder.DropTable(name: "move_side_effect_archives");

            migrationBuilder.DropTable(name: "piece_spawn_archives");

            migrationBuilder.DropTable(name: "quest_points");

            migrationBuilder.DropTable(name: "rating_archives");

            migrationBuilder.DropTable(name: "refresh_tokens");

            migrationBuilder.DropTable(name: "starred_users");

            migrationBuilder.DropTable(name: "user_preferences");

            migrationBuilder.DropTable(name: "win_streaks");

            migrationBuilder.DropTable(name: "AspNetRoles");

            migrationBuilder.DropTable(name: "move_archives");

            migrationBuilder.DropTable(name: "AspNetUsers");

            migrationBuilder.DropTable(name: "game_archives");

            migrationBuilder.DropTable(name: "player_archives");
        }
    }
}
