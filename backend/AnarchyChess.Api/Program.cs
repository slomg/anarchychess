...
builder
    ...
    .AddClient(options =>
    {
        ...
        //  https://github.com/openiddict/openiddict-core/issues/2428#issuecomment-3949667496
        ...
        options.AddEventHandler<OpenIddictClientEvents.ProcessAuthenticationContext>(builder =>
        {
            ...
            builder.UseInlineHandler(context =>
            {
                ...
                if (
                    context.Configuration.AuthorizationResponseIssParameterSupported is true
                    || (
                        context.Registration.ProviderType
                            is OpenIddictClientWebIntegrationConstants.ProviderTypes.Google
                ...
                )
                {
                    ...
                    if (
                        ...
                        || uri != context.Registration.Issuer
                    )
                    {
                        context.Reject(
                            error: Errors.InvalidRequest,
                ...
                // for more information.
                    ...
                    context.Registration.ProviderType
                        is not OpenIddictClientWebIntegrationConstants.ProviderTypes.Google
                    && !string.IsNullOrEmpty(issuer)
                )
                {
                    context.Reject(
                        error: Errors.InvalidRequest,
                        description: OpenIddictResources.FormatID2120(
                            Parameters.Iss,
