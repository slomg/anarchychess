...
public static class GameConstants
{
    public static readonly Dictionary<AlgebraicPoint, Piece> StartingPosition = new()
    {
        ...
        //[new Point("c1")] = new Piece(PieceType.Knook, GameColor.White),
        //[new Point("d1")] = new Piece(PieceType.Xook, GameColor.White),
        ...
        //[new Point("h1")] = new Piece(PieceType.Antiqueen, GameColor.White),
        ...
        //[new Point("c2")] = new Piece(PieceType.ChildPawn, GameColor.White),
        ...
        //[new Point("g2")] = new Piece(PieceType.ChildPawn, GameColor.White),
        ...
        //[new Point("c9")] = new Piece(PieceType.ChildPawn, GameColor.Black),
        ...
        //[new Point("h9")] = new Piece(PieceType.ChildPawn, GameColor.Black),
        ...
        //[new Point("c10")] = new Piece(PieceType.Knook, GameColor.Black),
        //[new Point("d10")] = new Piece(PieceType.Xook, GameColor.Black),
        ...
        //[new Point("h10")] = new Piece(PieceType.Antiqueen, GameColor.Black),
