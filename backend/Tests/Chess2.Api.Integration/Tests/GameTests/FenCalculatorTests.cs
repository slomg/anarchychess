...
public class FenCalculatorTests : BaseIntegrationTest
{
    ...
    public void CalculateFen_correctly_compresses_rows_with_different_piece_colors()
    {
        ...
        {
            [new Point(0, 0)] = new Piece(PieceType.King, PieceColor.White),
            [new Point(3, 0)] = new Piece(PieceType.Rook, PieceColor.Black),
            [new Point(6, 0)] = new Piece(PieceType.Queen, PieceColor.White),
            [new Point(2, 1)] = new Piece(PieceType.Pawn, PieceColor.White),
        };
    ...
    public void CalculateFen_correctly_places_a_piece_on_all_rows()
    {
        ...
        {
            [new Point(0, 0)] = new Piece(PieceType.King, PieceColor.White),
            [new Point(1, 1)] = new Piece(PieceType.Rook, PieceColor.Black),
            [new Point(2, 2)] = new Piece(PieceType.Queen, PieceColor.White),
            [new Point(3, 3)] = new Piece(PieceType.Pawn, PieceColor.Black),
        };
