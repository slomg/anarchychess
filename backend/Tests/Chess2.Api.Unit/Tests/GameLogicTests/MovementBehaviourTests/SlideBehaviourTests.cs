...
public class SlideBehaviourTests : AbstractMovementBehaviourTests
{
    [Theory]
...
public class SlideBehaviourTestData : TheoryData<Point, Point, IEnumerable<Point>>
{
    public SlideBehaviourTestData()
    {
        ...
        Add(
            new(1, 1),
            new(1, 1),
            [new(2, 2), new(3, 3), new(4, 4), new(5, 5), new(6, 6), new(7, 7), new(8, 8), new(9, 9)]
        );
