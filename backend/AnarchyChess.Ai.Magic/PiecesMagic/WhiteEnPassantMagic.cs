...
public sealed class WhiteEnPassantMagic : PieceMagic
{
    public override string Name => "WhiteEnPassant";

    public override UInt128 GenerateMask(int x, int y) =>
        SlideMask(x + 1, y, new Offset(X: 1, Y: 1)) | SlideMask(x - 1, y, new Offset(X: -1, Y: 1));
