...
export default async function SignInPage() {
    return (
        <main
            className="grid max-h-screen flex-1 justify-items-center
                md:grid-cols-[1.2fr_1.5fr]"
        >
            <section
                className="m-auto flex max-h-full max-w-2xl flex-col
                    items-center gap-10 overflow-auto p-10"
            >
