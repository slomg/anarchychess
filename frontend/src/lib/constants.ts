...
export const DEFAULT_CHESS_BOARD: PieceMap = new Map([
    ...
    ["10", { position: [0, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    ["11", { position: [1, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    // ["12", { position: [2, 1], pieceType: PieceType.ChildPawn, color: Color.Black }],
    ["13", { position: [3, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    ["14", { position: [4, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    ["15", { position: [5, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    ["16", { position: [6, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    // ["17", { position: [7, 1], pieceType: PieceType.ChildPawn, color: Color.Black }],
    ["18", { position: [8, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    ["19", { position: [9, 1], pieceType: PieceType.Pawn, color: Color.Black }],
    ...
    ["24", { position: [0, 8], pieceType: PieceType.Pawn, color: Color.White }],
    ["25", { position: [1, 8], pieceType: PieceType.Pawn, color: Color.White }],
    // ["26", { position: [2, 8], pieceType: PieceType.ChildPawn, color: Color.White }],
    ["27", { position: [3, 8], pieceType: PieceType.Pawn, color: Color.White }],
    ["28", { position: [4, 8], pieceType: PieceType.Pawn, color: Color.White }],
    ["29", { position: [5, 8], pieceType: PieceType.Pawn, color: Color.White }],
    ["30", { position: [6, 8], pieceType: PieceType.Pawn, color: Color.White }],
    // ["31", { position: [7, 8], pieceType: PieceType.ChildPawn, color: Color.White }],
    ["32", { position: [8, 8], pieceType: PieceType.Pawn, color: Color.White }],
    ["33", { position: [9, 8], pieceType: PieceType.Pawn, color: Color.White }],
