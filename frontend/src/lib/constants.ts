...
const DEFAULT_CHESS_BOARD: PieceMap = new Map([
    ...
    ["11", { position: logicalPoint({ x: 3, y: 1 }), type: PieceType.CHILDPAWN, color: GameColor.WHITE }],
    ...
    ["14", { position: logicalPoint({ x: 6, y: 1 }), type: PieceType.CHILDPAWN, color: GameColor.WHITE }],
    ...
    ["21", { position: logicalPoint({ x: 3, y: 8 }), type: PieceType.CHILDPAWN, color: GameColor.BLACK }],
    ...
    ["24", { position: logicalPoint({ x: 6, y: 8 }), type: PieceType.CHILDPAWN, color: GameColor.BLACK }],
