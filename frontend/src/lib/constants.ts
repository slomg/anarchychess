...
export const defaultChessBoard: ChessBoard = [
    ...
    { position: [4, 0], pieceType: PieceType.King, color: Color.Black },
    { position: [5, 0], pieceType: PieceType.Queen, color: Color.Black },
    ...
    { position: [4, 9], pieceType: PieceType.King, color: Color.White },
    { position: [5, 9], pieceType: PieceType.Queen, color: Color.White },
