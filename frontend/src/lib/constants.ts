...
const INITIAL_FEN =
    "rhnbqkb1ar/pppdppdppp/10/10/9+/+9/10/10/PPPDPPDPPP/RHNBQKB1AR";
...
const DEFAULT_CHESS_BOARD: PieceMap = new Map([
    ...
    // ["7", { position: logicalPoint({ x: 7, y: 0 }), type: PieceType.ANTIQUEEN, color: GameColor.WHITE }],
    ["7", { position: logicalPoint({ x: 8, y: 0 }), type: PieceType.ANTIQUEEN, color: GameColor.WHITE }],
    ...
    ["34", { position: logicalPoint({ x: 3, y: 9 }), type: PieceType.BISHOP, color: GameColor.BLACK }],
    ["35", { position: logicalPoint({ x: 4, y: 9 }), type: PieceType.QUEEN, color: GameColor.BLACK }],
    ["36", { position: logicalPoint({ x: 5, y: 9 }), type: PieceType.KING, color: GameColor.BLACK }],
    ["37", { position: logicalPoint({ x: 6, y: 9 }), type: PieceType.BISHOP, color: GameColor.BLACK }],
    // ["39", { position: logicalPoint({ x: 7, y: 9 }), type: PieceType.ANTIQUEEN, color: GameColor.BLACK }],
    ["38", { position: logicalPoint({ x: 8, y: 9 }), type: PieceType.ANTIQUEEN, color: GameColor.BLACK }],
