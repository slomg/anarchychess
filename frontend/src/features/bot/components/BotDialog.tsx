...
const GENERAL_DIALOG: string[] = [
    ...
    "One time I went into a shop and made anyone that enters buy an inflatable unicorn horn for cats.",
    ...
    "One time I made a park water fountain occasionally spray random people.",
    ...
    "One time I made all pens slide off the desk no matter where you placed them.",
    "I once rewrote the directions on all bathroom signs in a park for an hour and watched people go in circles.",
    "One time I made pigeons in a park line up in a spiral, people thought the government drones finally malfunctioned.",
    ...
    "One time I caused every vending machine in a mall to get stuck.",
    ...
    "One time I made every traffic cone in a city rotate 45 degrees every hour.",
    "One time I made a dog bark non stop for hours on end at 3 AM.",
