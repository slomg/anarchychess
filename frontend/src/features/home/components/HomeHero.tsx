...
const HomeHero = () => {
    return (
        <header
            className="bg-checkerboard relative flex flex-col items-center
                justify-center gap-10 overflow-hidden bg-center p-3 py-10
                md:gap-10 md:px-10 xl:flex-row xl:items-start xl:gap-20
                xl:py-35"
        >
            <div
                className="relative flex h-full flex-col text-center text-nowrap
                    xl:text-start"
                data-testid="homeHeroBanner"
            >
                <p className="text-4xl sm:text-5xl">Welcome To</p>
                <h1
                    className="text-7xl min-[375px]:text-8xl sm:text-9xl
                        xl:ml-10"
                >
                    CHESS
                </h1>
                ...
                <Image
                    ...
                    alt="knook"
                    width={700}
                    className="absolute -bottom-107 -left-70 hidden max-w-none
                        rotate-15 xl:block"
                    priority
                />
            </div>
            ...
            <div
                className="grid h-min max-w-180 grid-cols-2 items-stretch
                    gap-10"
            >
                <Card
                    className="border-accent relative col-span-2 justify-between
                        gap-5 border-4 p-2"
                >
                ...
                <Card
                    className="bg-background border-primary justify-between
                        border-4 p-2 sm:gap-10"
                >
                    <div className="flex flex-col gap-2">
