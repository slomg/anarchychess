...
export class GameRequestsApi extends runtime.BaseAPI {
    ...
    async startPoolGameRaw(
        requestParameters: StartPoolGameRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<any>> {
        if (
            requestParameters.gameSettings === null ||
            requestParameters.gameSettings === undefined
        ) {
            throw new runtime.RequiredError(
                "gameSettings",
                "Required parameter requestParameters.gameSettings was null or undefined when calling startPoolGame."
            );
        }
        ...
        const response = await this.request(
            {
                ...
                headers: headerParameters,
                query: queryParameters,
                body: requestParameters.gameSettings,
            },
            initOverrides
        );
    ...
    async startPoolGame(
        ...
        const response = await this.startPoolGameRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();
